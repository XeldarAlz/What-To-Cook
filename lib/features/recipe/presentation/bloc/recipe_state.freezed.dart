...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(this.recipe);
  ...
  @override
  String toString() {
    return 'RecipeState.loaded(recipe: $recipe)';
  }
...
abstract class _Loaded implements RecipeState {
  const factory _Loaded(final Recipe recipe) = _$LoadedImpl;
